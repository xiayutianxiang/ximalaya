...
public class PlayListAdapter extends RecyclerView.Adapter<PlayListAdapter.InnerHolder> {
    ...
    private SobPopWindow.PlayListItemClickListener mItemClickListener;

    @NonNull
    @Override
    public InnerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(BaseApplication.getAppContext()).inflate(R.layout.item_play_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull InnerHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mItemClickListener != null) {
                    mItemClickListener.omItemClick(position);
                }
            }
        });
        //设置数据
        ...
        trackTitleTv.setTextColor(
                BaseApplication.getAppContext().getResources().getColor(playingIndex == position ? R.color.second_color :
    ...
    public void setOniItemClickListener(SobPopWindow.PlayListItemClickListener listener) {
